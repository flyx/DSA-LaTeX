...
\begin{document}
  ...
  \begin{multicols}{2}
    ...
    Diese Klasse kann nur mit \XeTeX \ oder \LuaTeX \ benutzt werden. Das ist vor
    allem deshalb so, weil normales \TeX \ nicht in der Lage ist die im System
    installierten TrueType-Schriftarten zu verwenden. Außerdem hat man mit
    \XeTeX \ und  \LuaTeX \ nicht ständig das Problem mit der mangelhaften
    Unicode-Unterstützung (im Deutschen vor allem für Umlaute wichtig).
    Entsprechend musst du deine Dokumente immer mit dem Kommando \texttt{xelatex}
    bzw. \texttt{lualatex} setzen. Wenn du einen grafischen \LaTeX-Editor
    verwendest, sollte dieser eine entsprechende Einstellung haben.
...
\twocolumn[\section*{Überschrift}]\end{lstlisting}
  ...
  \begin{dsaBoxLandscape}
    ...
    \begin{multicols}{2}
      Es sind drei Größen für Boxen verfügbar, die mit
      folgenden Umgebungen genutzt werden können:
    ...
    \columnbreak
      ...
      Standardmäßig werden die Boxen nicht in eine \texttt{float}-Umgebung
      gepackt, denn die Boxen sollten schon genau dort erscheinen, wo der
      Autor sie haben möchte. Bildverweise oder ähnliches sind hier wohl
      eher fehl am Platz.
      
      Der Inhalt in den Boxen befindet sich von Haus aus in einer Minipage,
  ...
  \begin{dsaCharacterSheet}
    ...
    \begin{multicols}{2}
      \begin{dsaSheetBox}[8.5cm]
        ...
        \texttt{\textbackslash linewidth} ist. Zusätzlich kann das Spacing
        des enthaltenen Textes zur Umrandung mittels \texttt{\textbackslash
        setlength\{\textbackslash fboxsep\}\{<Länge>\}} angepasst werden.
      ...
      \begin{dsaSheetBox}[8.5cm]
        ...
        \texttt{<name>} ist der Name des Textfelds. Dieser wird nirgends angezeigt,
        es muss allerdings darauf geachtet werden, dass kein Name doppelt benutzt
