...
\begin{dsaSheetBox}[\textwidth]
    ...
    \begin{tabular}{llllllll}
        Attacke-Basiswert: & \smallnum{\FroEigAktuell{15}} & Parade-Basiswert: & \smallnum{\FroEigAktuell{16}} & Fernkampf-Basiswert: & \smallnum{\FroEigAktuell{17}} & Initiative-Basiswert: & \smallnum{\FroEigAktuell{14}}
    \end{tabular}
    \vspace{-1pt}
\end{dsaSheetBox}
    ...
    \begin{dsaSheetBox}
        ...
        \begin{tabu}{p{4.8cm}|p{2.6cm}|p{1cm}|p{1.4cm}|p{0.8cm}|p{0.5cm}|p{0.5cm}}
            ...
            \forloop{ct}{0}{\value{ct} < #1}{%
                ...
                \mediumtext[centered]{\KamSchTyp{\thect}}{2cm} &
...
\newcommand{\Ausweichen}{%
    ...
    \begin{dsaSheetBox}
        ...
        \begin{tabular}{p{1cm}p{0.3cm}p{0.7cm}p{0.3cm}p{2.5cm}p{0.3cm}p{1cm}}
            ...
            \end{minipage}
             & \normalsize $=$ &
            \raisebox{-1.5ex}{\textField[\ui{align={centered},textsize={14}}]{\KamAusAusweichenwert}{0.9cm}{2em}} \\ \Xcline{1-1}{3\arrayrulewidth} \Xcline{3-3}{3\arrayrulewidth} \Xcline{7-7}{3\arrayrulewidth}
...
\newcommand{\LebensenergieAusdauerEtc}[2]{
    ...
    \begin{dsaSheetBox}
        ...
        \begin{tabular}{p{3cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{11.1cm}}
            ...
            \footnotesize Lebensenergie & \textField[\ui{align={centered}}\textSize{9}\Ff{\FfReadOnly}]{\FroEigAktuell{9}}{1cm}{10pt} & \mediumtext{\KamStaab{0}}{1cm} & \mediumtext{\KamStaac{0}}{1cm} & \mediumtext{\KamStaad{0}}{1cm} & \\ \hline
            \footnotesize Ausdauer & \textField[\ui{align={centered}}\textSize{9}\Ff{\FfReadOnly}]{\FroEigAktuell{10}}{1cm}{10pt} & \mediumtext{\KamStaab{1}}{1cm} & \mediumtext{\KamStaac{1}}{1cm} & \mediumtext{\KamStaad{1}}{1cm} & \\ \hline
            \ifthenelse{\equal{#1}{1}}{
                \footnotesize Astralenergie & \textField[\ui{align={centered}}\textSize{9}\Ff{\FfReadOnly}]{\FroEigAktuell{11}}{1cm}{11.5pt} & \multicolumn{4}{l}{} \\ \hline
            }{}
            \ifthenelse{\equal{#2}{1}}{
                \footnotesize Karmaenergie & \textField[\ui{align={centered}}\textSize{9}\Ff{\FfReadOnly}]{\FroEigAktuell{12}}{1cm}{11.5pt} & \multicolumn{4}{l}{} \\ \hline
            }{}
        \end{tabular}
