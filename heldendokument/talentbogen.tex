...
\begin{dsaSheetBox}[\textwidth]
    ...
    \begin{tabular}{llllllllllllllllll}
        MU: & \smallnum{MU-akt} & KL: & \smallnum{KL-akt} & IN: & \smallnum{IN-akt} & CH: & \smallnum{CH-akt} & FF: & \smallnum{FF-akt} & GE: & \smallnum{GE-akt} & KO: & \smallnum{KO-akt} & KK: & \smallnum{KK-akt} & \hspace{10pt} BE: & \smallnum{BE}
    \end{tabular}
    \vspace{-1pt}
\end{dsaSheetBox}
            ...
            \begin{tabular}{p{0.2cm}|p{4.6cm}|p{0.4cm}|p{1cm}|p{0.7cm}!{\footnotesize\raisebox{-0.2pt}{•}}p{0.7cm}|p{0.8cm}}
                ...
                {%
                    ...
                    \ifthenelse{\equal{\TalenteInCombo}{1}}{
                        \raisebox{-0.1ex}{\comboBox[\Ff\FfEdit\ui{value={\KampftechnikenBasis{\thect}{0}}}\textSize{8}\W{0}]{Kampftechniken-Name\thect}{4.6cm}{10pt}{\KampftechnikenTalentliste}}
                    }{
        ...
        \else
            \begin{tabular}{p{0.2cm}|p{4.15cm}|p{0.4cm}|p{1cm}|p{0.7cm}!{\footnotesize\raisebox{-0.2pt}{•}}p{0.7cm}|p{0.8cm}|p{0.4cm}}
                ...
                {%
                    ...
                    \checkBox[\symbolchoice{star}\BC{}]{Kampftechniken-SE\thect}{0.2cm}{0.2cm} &
                    \ifthenelse{\equal{\TalenteInCombo}{1}}{
                        \raisebox{-0.1ex}{\comboBox[\Ff\FfEdit\ui{value={\KampftechnikenBasis{\thect}{0}}}\textSize{8}\W{0}]{Kampftechniken-Name\thect}{4.15cm}{10pt}{\KampftechnikenTalentliste}}
                    }{
        ...
        \begin{tabular}{p{0.2cm}|p{6.85cm}|p{1cm}|p{0.8cm}}
            ...
            \forloop{ct}{0}{\value{ct} < #1}{%
                ...
                \ifthenelse{\equal{\thect}{0}}{
                    ...
                    \ifthenelse{\equal{\TalenteInCombo}{1}}{
                        \raisebox{-0.1ex}{\comboBox[\Ff\FfEdit\textSize{8}\W{0}]{Sprachen-Name\thect}{5cm}{10pt}{\SprachenTalentliste}}
                    }{
                        \smalltext{Sprachen-Name\thect}{5cm}{}
                    } &
                }{
                    \ifthenelse{\equal{\TalenteInCombo}{1}}{
                        \raisebox{-0.1ex}{\comboBox[\Ff\FfEdit\textSize{8}\W{0}]{Sprachen-Name\thect}{6.85cm}{10pt}{\SprachenTalentliste}}
                    }{
