...
\begin{dsaSheetBox}[\textwidth]
    \begin{tabular}{llllllllllllllllll}
        \raisebox{2pt}{MU:} & \smallnum{\FroEigAktuell{0}} &
        \raisebox{2pt}{KL:} & \smallnum{\FroEigAktuell{1}} &
        \raisebox{2pt}{IN:} & \smallnum{\FroEigAktuell{2}} &
        \raisebox{2pt}{CH:} & \smallnum{\FroEigAktuell{3}} &
        \raisebox{2pt}{FF:} & \smallnum{\FroEigAktuell{4}} &
        \raisebox{2pt}{GE:} & \smallnum{\FroEigAktuell{5}} &
        \raisebox{2pt}{KO:} & \smallnum{\FroEigAktuell{6}} &
        \raisebox{2pt}{KK:} & \smallnum{\FroEigAktuell{7}} & \hspace{10pt}
        \raisebox{2pt}{BE:} & \smallnum{\KamRusResultierendeBehinderung}
    \end{tabular}
    \vspace{-4pt}
\end{dsaSheetBox}
            ...
            \ifcase#5\relax
                \begin{tabular}{p{0.2cm}|p{5.8cm}|p{0.5cm}!{\footnotesize\raisebox{-0.6pt}{•}}p{0.5cm}!{\footnotesize\raisebox{-0.6pt}{•}}p{0.5cm}|p{0.8cm}}
                    ...
                    \forloop{ct}{0}{\value{ct} < #3}{%
                        ...
                        \shifttext{-0.15cm}{\smalltext[centered]{\TalTalEigenschaftc{#1}{\thect}}{0.7cm}{#6{\thect}{3}}} &
