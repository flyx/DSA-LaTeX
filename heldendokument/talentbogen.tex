            ...
            \ifcase#5\relax
                \begin{tabular}{p{0.2cm}|p{5.8cm}|p{0.5cm}!{\footnotesize\raisebox{0.35ex}{•}}p{0.5cm}!{\footnotesize\raisebox{0.35ex}{•}}p{0.5cm}|p{0.8cm}}
                    ...
                    \forloop{ct}{0}{\value{ct} < #3}{%
                        ...
                        \shifttext{-0.225cm}{\smalltext[centered]{#1-Eigenschaft1-\thect}{0.7cm}{#6{\thect}{1}}} &
                        \shifttext{-0.225cm}{\smalltext[centered]{#1-Eigenschaft2-\thect}{0.7cm}{#6{\thect}{2}}} &
                        \shifttext{-0.225cm}{\smalltext[centered]{#1-Eigenschaft3-\thect}{0.7cm}{#6{\thect}{3}}} &
