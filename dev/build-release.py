...
for readme in [["README-release.md", "README.html"], ["README-VM.md", "README-VM.html"]]:
   with codecs.open(sys.argv[1] + readme[0], 'r', encoding='utf-8') as input:
      with codecs.open(sys.argv[2] + readme[1], 'w', encoding='utf-8') as output:
         output.write(u"""
            <!doctype html>
            <html>
            <head>
